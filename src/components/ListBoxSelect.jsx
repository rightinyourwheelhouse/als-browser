	...
	return (
		<div className="mb-0">
			...
			<select
				...
				} focus:ring-skin-accent placeholder:text-md mt-2 mb-0 h-10 w-full max-w-lg rounded-md border-2 py-0 px-4 text-sm font-medium hover:border hover:border-dark-blue hover:shadow-[0px_0px_0px_4px_#4c7bea4c] hover:transition-all focus:outline-none focus:ring-2 focus:ring-offset-2`}
				type={type}
				name={name}
				value={currentValue}
				onChange={(e) => {
