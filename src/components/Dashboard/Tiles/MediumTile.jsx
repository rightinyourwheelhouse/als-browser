...
const MediumTile = ({ title, img, url }) => {
	...
	return (
		<button
			...
			className="mb-4 flex min-w-max items-center justify-start gap-4 rounded-2xl bg-white pr-4 drop-shadow-light transition duration-300 ease-in-out hover:scale-105 hover:drop-shadow-hover"
		>
