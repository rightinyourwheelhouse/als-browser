		...
		<div>
			<div>
				<div className="m-center mt-20 w-3/4">
					...
					<div className="mt-6 w-3/4 cursor-pointer rounded-2xl bg-white p-6 drop-shadow-light transition duration-300 ease-in-out hover:drop-shadow-hover">
					...
					<div className="mt-6 w-3/4 cursor-pointer rounded-2xl bg-white p-6 drop-shadow-light transition duration-300 ease-in-out hover:drop-shadow-hover">
						<div className="flex flex-row gap-8">
							<div className="flex min-w-fit items-center gap-4">
								...
								<div className="">
									<a className="w-fit text-sm font-light underline underline-offset-1">
